...
('root', '[{\"db\":\"vietgram\",\"table\":\"profile\"},{\"db\":\"vietgram\",\"table\":\"photo\"},{\"db\":\"vietgram\",\"table\":\"user\"}]');
...
('root', '2020-03-10 13:40:51', '{\"Console\\/Mode\":\"collapse\"}');
...
(1, 1, 'images/feedPhoto.jpg', 'love this!', 45);
...
CREATE TABLE `profile` (
  ...
  `gender` enum('male','female','can''t_remember') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `profile` (`id`, `user_id`, `name`, `website`, `bio`, `phone_num`, `gender`) VALUES
(1, 1, 'asd', 'https://www.wikipedia.org/', 'asd', '085155197975', '');
...
(1, 'asd', 'nopal123', 'naufalharsap@gmail.com');
